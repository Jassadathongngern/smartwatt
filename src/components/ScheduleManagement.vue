...
const openEditModal = (item) => {
  ...
  // แปลงเวลา "09:00 - 12:00" กลับเป็น startTime/endTime เพื่อใส่ในฟอร์ม
...
.icon-btn {
  border: 1px solid #000; background: white; color: #000;
  cursor: pointer; padding: 6px; border-radius: 6px; margin: 0 4px;
